...
class DbDCommunicationApp:
    ...
    def setup_main_interface(self):
        ...
        ttk.Label(control_frame, text="Manual map:").grid(row=0, column=1, padx=(10, 5))
        ...
        settings_frame.grid(row=3, column=0, columnspan=2, sticky="ew", pady=(0, 10))
        
        # Sector mode selection
        ttk.Label(settings_frame, text="Sector Mode:").grid(row=0, column=0, sticky="w")
        ...
        instructions_frame.grid(row=4, column=0, columnspan=2, sticky="ew", pady=(0, 10))
...
4. Use callouts like "killer in 3" or "rescue in 9" """
    ...
    def start_detection(self):
        ...
        self.status_label.config(text="Detection active - monitoring for maps...")
