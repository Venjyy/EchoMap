...
class OCRDetector:
    ...
    def __init__(self, config_path="config/ocr_config.json"):
        ...
        # Screenshot settings
        self.screenshot_region = self.config.get("screenshot_region", (50, 850, 400, 950))
    ...
    def take_screenshot(self, region=None):
        ...
        try:
            ...
            screenshot_path = Path("screenshots") / f"map_detection_{timestamp}.png"
    ...
    def detect_map(self):
        ...
        try:
            ...
            if map_name:
                ...
                self.logger.debug("No valid map name detected from: '%s'", raw_text)
                return None
